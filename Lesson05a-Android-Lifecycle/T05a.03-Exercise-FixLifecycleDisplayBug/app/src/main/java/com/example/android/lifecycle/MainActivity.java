...
public class MainActivity extends AppCompatActivity {
    ...
    private static List<String> mLifecycleCallbacks = new ArrayList<String>();
...
//                mLifecycleDisplay.setText(allPreviousLifecycleCallbacks);
                callbacksString = allPreviousLifecycleCallbacks;
            }
        }
        ...
        for (String callback: mLifecycleCallbacks) {
            callbacksString += callback + "\n";
        }

        mLifecycleDisplay.setText(callbacksString);
