...
public class MainActivity extends AppCompatActivity {
    ...
    private static String BUNDLE_KEY_URL = "url";
    // (2) Create a static final key to store the search's raw JSON
    private static String BUNDLE_KEY_RESULT_JSON = "result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(BUNDLE_KEY_URL)) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(BUNDLE_KEY_URL));
            }
            if (savedInstanceState.containsKey(BUNDLE_KEY_RESULT_JSON)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(BUNDLE_KEY_RESULT_JSON));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(BUNDLE_KEY_URL, url);
        ...
        outState.putString(BUNDLE_KEY_RESULT_JSON, results);
    }
