...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setColor(getColorFromSharedPreferences(sharedPreferences));
    ...
    private String getColorFromSharedPreferences(SharedPreferences sharedPreferences) {
        return sharedPreferences
                .getString(getString(R.string.pref_select_color_key), getString(R.string.pref_color_blue_value));
    }
