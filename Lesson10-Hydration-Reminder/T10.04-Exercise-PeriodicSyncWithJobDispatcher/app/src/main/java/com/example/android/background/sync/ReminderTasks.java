...
public class ReminderTasks {
    ...
    // JB: Unique action for issuing a charge reminder
    public static final String ACTION_ISSUE_CHARGING_REMINDER = "charging-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_ISSUE_CHARGING_REMINDER.equals(action)) {
