...
public class ReminderUtilities {
    ...
    private final static int REMINDER_INTERVAL_MINUTES = 15;
    ...
    private final static String REMINDER_JOB_TAG = "hydration_reminder_tag";
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        ...
        Job job = firebaseJobDispatcher.newJobBuilder().setService(WaterReminderFirebaseJobService.class)
